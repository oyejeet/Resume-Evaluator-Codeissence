...
const Footer = () => {
  return (
    <footer className="bg-theme-black pt-16 pb-8 border-t border-theme-green/20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-theme-green">CareerCraft</h3>
            <p className="text-sm text-theme-green/70">
              Bridging the gap between job seekers and recruiters with a free, accessible platform.
            </p>
          </div>
          
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider text-theme-green/80">For Job Seekers</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider text-theme-green/80">For Recruiters</h4>
            <ul className="space-y-2">
              <li>
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider text-theme-green/80">Resources</h4>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-theme-green/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-xs text-theme-green/60">
              &copy; {new Date().getFullYear()} CareerCraft. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-theme-green/60 hover:text-theme-green transition-colors">
